...
class MagicalContainer{
    ...
    class AscendingIterator{
        ...
        AscendingIterator(MagicalContainer& other);
    ...
    vector<SideCrossIterator*> sideVector;
    vector<PrimeIterator*> primeVector;
    vector<AscendingIterator*> AscendVector;
    void addTovector(AscendingIterator& vec);
};
#endif